                                        ...
                                        <tbody>
                                          @foreach($facultades as $facultad)
                                            <tr>
                                                ...
                                                <a href="{{asset('/unipana/facultad/'.$facultad->id.'/editar')}}" class="btn btn-secondary btn-lg mb-1"> <i class="fas fa-edit"></i> </a>
                                                <a href="{{asset('/unipana/facultad/'.$facultad->id.'/destroy')}}" onclick="
