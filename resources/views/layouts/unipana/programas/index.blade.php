                      ...
                      <div class="col-xl-12">
                        <div class="card spur-card">
                                <div class="card-header">
                                    ...
                                    <div class="spur-card-title">Programas</div>
                                </div>
                                        ...
                                        <tbody>
                                          @foreach($programas as $programa)
                                            <tr>
                                                ...
                                                <a href="{{asset('/unipana/programa/'.$programa->id.'/editar')}}" class="btn btn-secondary btn-lg mb-1"> <i class="fas fa-edit"></i> </a>
                                                <a href="{{asset('/unipana/programa/'.$programa->id.'/destroy')}}" onclick="
