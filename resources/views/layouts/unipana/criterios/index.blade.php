                                        ...
                                        <tbody>
                                          @foreach($criterios as $criterio)
                                            <tr>
                                                ...
                                                <a href="{{asset('/unipana/criterio/'.$criterio->id.'/editar')}}" class="btn btn-secondary btn-lg mb-1"> <i class="fas fa-edit"></i> </a>
                                                <a href="{{asset('/unipana/criterio/'.$criterio->id.'/destroy')}}" onclick="
