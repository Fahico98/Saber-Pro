                                        ...
                                        <tbody>
                                          @foreach($asignaturas as $asignatura)
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{asset('/relacion/'.$asignatura->id.'/editar')}}" class="btn btn-primary btn-lg mb-1"> <i class="fas fa-list-alt"></i> </a>
                                                <a href="{{asset('/unipana/asignatura/'.$asignatura->id.'/editar')}}" class="btn btn-secondary btn-lg mb-1"> <i class="fas fa-edit"></i> </a>
                                                <a href="{{asset('/unipana/asignatura/'.$asignatura->id.'/destroy')}}" onclick="
